...
def main():
    ...
    parser.add_argument(
        '-mix_scp', type=str, default='/lustre/users/shi/datasets/librimix/ConvTasNet/ConvTasNet_Separation_WavLM_CAtt/data/audio_scp_8k/test/clean/tt_mix.scp', help='Path to mix scp file.')
    parser.add_argument(
        '-yaml', type=str, default='./options/train/train.yml', help='Path to yaml file.')
    parser.add_argument(
        '-model', type=str, default='/mnt/Conv-TasNet/Conv_TasNet_Pytorch/Conv-TasNet-new/best.pt', help="Path to model file.")
    parser.add_argument(
